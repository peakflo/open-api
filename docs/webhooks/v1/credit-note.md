...
| amountConv | number | The applied amount converted to destination currency. |
| currencyRate | number | The exchange rate used for the applied amount conversion. |
| wht | object | The withholding tax details for the applied amount, if present. |
